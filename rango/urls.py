...
from rango.views import AboutView, AddCategoryView, IndexView, AddPageView, ShowCategoryView, RestrictedView, RegisterProfileView, GoToView, ProfileView, ListProfileView
